...
script += 'cd $directory\n'
script += 'sleep 3\n'
script += 'cp /junofs/users/wanghanwen/sipm-massive/script/harvest.py .\n'
script += 'cp /junofs/users/wanghanwen/sipm-massive/valid-run.yaml .\n'
script += 'cp /junofs/users/wanghanwen/sipm-massive/reff-pde.yaml .\n'
...
script += 'harvest_command="$python harvest.py ${file_path} ${run_info} ${output_file}"\n'
script += 'echo "Executing command: ${harvest_command}"\n'
