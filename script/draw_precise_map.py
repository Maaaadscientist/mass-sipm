...
if __name__ == '__main__':
    ...
    for file in root_files:
        ...
        x_start, x_end, x_step = -40, 320, 0.2  # You can adjust the step to whatever you want
        y_start, y_end, y_step = -40, 320, 0.2  # You can adjust the step to whatever you want
